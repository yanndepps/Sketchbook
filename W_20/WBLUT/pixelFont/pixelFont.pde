...
void draw() {
  ...
  fill(0);
  text3xN("abcdefghijklmnopqrstuvwxyz", 0, 400,9, 15, 15, CENTER,CENTER,false);//LEFT/CENTER/RIGHT, TOP/BOTTOM/RIGHT
  text3xN("abcdefghijklmnopqrstuvwxyz", 0, 215,9, 15, 15, CENTER,CENTER,true);
  text3xN("0123456789", 0, 30,9, 15, 15, CENTER,CENTER,false);
  text3xN("0123456789", 0, -155,9, 15, 15, CENTER,CENTER,true);
  text3x3("abcdefghijklmnopqrstuvwxyz", 0, -320, 15, 15,CENTER,CENTER);
  text3x3("0123456789", 0, -420, 15, 15,CENTER,CENTER);
}
