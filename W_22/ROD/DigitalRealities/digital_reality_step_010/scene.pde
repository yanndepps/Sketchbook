void scene() {
  ...
  rotateY(radians(90 + mx));

  // pointLight(255,255,255,width/2 + m,height/2,cameraZ);
  ...
  beginShape();
  texture(floor);
  vertex(-MAGNITUDE, -MAGNITUDE, 0, 0);
  vertex(MAGNITUDE, -MAGNITUDE, 1, 0);
  vertex(MAGNITUDE, MAGNITUDE, 1, 1);
  vertex(-MAGNITUDE, MAGNITUDE, 0, 1);
  endShape();
